  ...
  return (
    <div className='group relative flex cursor-pointer'>
        ...
        <motion.img
            ...
            whileInView={{ opacity: 1, x: 0 }}
            src={titlesrc}
            className='rounded-full border border-gray-500 object-cover w-8 h-8 md:w-24 md:h-24 
            filter group-hover:grayscale transition duration-300 ease-in-out'
        />
        <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-8
        w-8 md:w-24 md:h-24 rounded-full z-0'>
            <div className='flex items-center justify-center h-full'>
                <p className='text-xs md:text-3xl font-bold text-black opacity-100'>{proficiency}%</p>
            </div>
        </div>
