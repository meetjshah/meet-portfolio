  ...
  return (
    ...
    className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        initial={{
            ...
            viewport={{ once: true }}
            src="Meet_photo_.jpg"
            className='-mb-72 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[500px] xl:h-[600px]'
        />

        <div className=' pt-48 md:pt-56 space-y-0 md:space-y-10 px-0 md:px-10'>
            <h4 className='text-lg pb-[1px] md:pb-0 md:text-4xl font-semibold'>
                Here is a{' '}
